...
class config(object):
    ...
    def __init__(self,mode=2):
        ...
        mupif_dir = '/home/CSuser/.local/lib/python3.6/site-packages/mupif-2.0.1-py3.6.egg/mupif'
        ...
        #Name of job manager
        self.jobManName='ESI_VPS_Jobmanager'
        #Name of first application
        self.appName = 'ESI_VPS'
        ...
        self.jobManWorkDir='/home/CSuser/COMPOSELECTOR/MUPIF_JM_WORKDIR'
        #Path to JobMan2cmd.py
        self.jobMan2CmdPath = mupif_dir + "/tools/JobMan2cmd.py"
...
#            self.appName2 = 'MuPIFServer2'
        ...
        if self.mode == 2:#VPN, no ssh tunnels
            ...
            self.server = '172.30.0.91'   # ESI WS in Stuttgart ESI-01.ovpn script
            #Port of server's daemon
            self.serverPort = 44382
            #Nat IP/name
            self.serverNathost = None
